  ...
  return (
    <>
            ...
            <div className="text-center my-2">
              ...
              <button className='org-button mx-2' id="spectrum-6" onClick={()=>fetchData(6,2024)} >Block-6</button>
              <button className='org-button mx-2' id="spectrum-7" onClick={()=>fetchData(7,2024)}>Block-7</button>
            ...
            <div className="text-center my-2">
              ...
              <button className='org-button mx-2' id="spectrum-10" onClick={()=>fetchData(10,2024)}>Block-10</button>
              <button className='org-button mx-2' id="spectrum-11" onClick={()=>fetchData(11,2024)}>Block-11</button>
            ...
            <div className="text-center my-2">
              ...
              <button className='org-button mx-2' id="spectrum-14" onClick={()=>fetchData(14,2024)}>Block-14</button>
              <button className='org-button mx-2' id="spectrum-15" onClick={()=>fetchData(15,2024)}>Block-15</button>
            ...
            <div className="text-center my-2">
              ...
              <button className='org-button mx-2' id="spectrum-18" onClick={()=>fetchData(18,2024)}>Block-18</button>
              <button className='org-button mx-2' id="spectrum-19" onClick={()=>fetchData(19,2024)}>Block-19</button>
              <button className='my-button mx-2' id="spectrum-20" onClick={()=>fetchData(20,2024)}>Block-20</button>
            </div>
            <div className="text-center my-2">
              <button className='org-button mx-2' id="spectrum-21" onClick={()=>fetchData(21,2024)}>Block-21</button>
              <button className='org-button mx-2' id="spectrum-22" onClick={()=>fetchData(22,2024)}>Block-22</button>
            </div>
            <div className="text-center my-2">
