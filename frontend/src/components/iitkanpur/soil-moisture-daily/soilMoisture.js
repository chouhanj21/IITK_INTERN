...
function SoilMoistureDaily() {
    ...
    const handleSubmit = async (e) => {
        ...
        setIsLoading(true);
        try {
            const response = await axios.post("http://localhost:5000/data-collection/soil-moisture/iitk-daily",
                {
...
export default SoilMoistureDaily;
