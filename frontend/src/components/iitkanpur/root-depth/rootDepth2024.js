  ...
  return (
    <>
            ...
            <div className="text-center my-2">
              ...
              <button className='org-button mx-2 org-disable-link' id="spectrum-7">Block-7</button>
            ...
            <div className="text-center my-2">
              ...
              <button className='my-button mx-2 disable-link' id="spectrum-12">Block-12</button>
            </div>
            <div className="text-center my-2">
              <button className='my-button mx-2' id="spectrum-13" onClick={()=>fetchData(13,2024)}>Block-13</button>
              <button className='org-button mx-2 org-disable-link' id="spectrum-14">Block-14</button>
